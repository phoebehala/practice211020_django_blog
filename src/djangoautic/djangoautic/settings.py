...
SECRET_KEY = 'django-insecure-b&nj&+&(@2hx@qy^)3(9ct!k4htj(t^a-z74_(esyp!qgypiy9'
...
TEMPLATES = [
    {
        ...
        #directory >> to indicate where our templates stored
        'DIRS': ['templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# it's the url where we go to to find our static file
...
# where static files will be found in the base(root) directory then look in the 'assets' folder
STATICFILES_DIRS = (
